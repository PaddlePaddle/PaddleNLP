...
# root_dir="checkpoints/dropout_0.300000_batch_size_128 " 
...
python -u -m paddle.distributed.launch --gpus "3" --log_dir "recall_log/" \
        ...
        --recall_result_dir "recall_result_dir" \
        --recall_result_file "recall_result.txt" \
        --params_path "${root_dir}/model_30000/model_state.pdparams" \
        --hnsw_m 100 \
        --hnsw_ef 100 \
        --batch_size 64 \
        --output_emb_size 256\
...
python -u -m paddle.distributed.launch --gpus "3" --log_dir "recall_log/" \
        ...
        --recall_result_dir "recall_result_dir" \
        --recall_result_file "recall_result.txt" \
        --params_path "${root_dir}/model_40000/model_state.pdparams" \
        --hnsw_m 100 \
        --hnsw_ef 100 \
        --batch_size 64 \
        --output_emb_size 256\
...
python -u -m paddle.distributed.launch --gpus "3" --log_dir "recall_log/" \
        ...
        --recall_result_dir "recall_result_dir" \
        --recall_result_file "recall_result.txt" \
        --params_path "${root_dir}/model_46000/model_state.pdparams" \
        --hnsw_m 100 \
        --hnsw_ef 100 \
        --batch_size 64 \
        --output_emb_size 256\
