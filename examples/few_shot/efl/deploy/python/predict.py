...
class Predictor(object):
    ...
    def predict(self, data, tokenizer):
        ...
        examples = []
        for text in data:
            input_ids, segment_ids = convert_example(text, tokenizer, is_test=True)
...
if __name__ == "__main__":
    ...
    batches = [test_ds[idx : idx + args.batch_size] for idx in range(0, len(test_ds), args.batch_size)]
