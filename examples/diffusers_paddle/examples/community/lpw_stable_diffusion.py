...
import PIL
from diffusers_paddle.configuration_utils import FrozenDict
from diffusers_paddle.models import AutoencoderKL, UNet2DConditionModel
from diffusers_paddle.pipeline_utils import DiffusionPipeline
from diffusers_paddle.pipelines.stable_diffusion import StableDiffusionPipelineOutput
from diffusers_paddle.pipelines.stable_diffusion.safety_checker import StableDiffusionSafetyChecker
from diffusers_paddle.schedulers import DDIMScheduler, LMSDiscreteScheduler, PNDMScheduler
from diffusers_paddle.utils import deprecate, logging
...
class StableDiffusionLongPromptWeightingPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        init_image: Union[paddle.Tensor, PIL.Image.Image] = None,
        ...
        **kwargs,
        ...
        if do_classifier_free_guidance:
            ...
            uncond_embeddings = paddle.tile(uncond_embeddings,
