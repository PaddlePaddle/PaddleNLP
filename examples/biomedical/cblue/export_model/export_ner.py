...
parser.add_argument('--num_classes', type=list, default=[33, 5], help='The number of labels in accordance with the training dataset.')
...
if __name__ == "__main__":
    model = ElectraForBinaryTokenClassification.from_pretrained(
        "ernie-health-chinese", num_classes=args.num_classes)
