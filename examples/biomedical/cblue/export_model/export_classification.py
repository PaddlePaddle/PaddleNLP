...
parser.add_argument('--num_classes', type=int, required=True, default=2, help='The number of labels in accordance with the training dataset.')
...
if __name__ == "__main__":
    model = ErnieForSequenceClassification.from_pretrained(
        "ernie-health-chinese", num_classes=args.num_classes, activation='tanh')
