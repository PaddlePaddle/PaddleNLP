...
def get_optimizer(args, model, train_data_loader):
    if args.max_steps == -1:
        args.max_steps = len(train_data_loader) * args.num_train_epochs
                ...
                for step, batch in enumerate(train_data_loader):
                    ...
                    if global_step % args.eval_freq == 0:
                        ...
                        run_evaluate(valid_data_loader, model, criterion,
                                     log_writer, global_step, epoch, "valid")
                    ...
                    if global_step >= args.max_steps:
                        run_evaluate(test_data_loader, model, criterion,
                                     log_writer, global_step, epoch, "test")
