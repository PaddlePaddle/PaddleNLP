...
def parse_args(MODEL_CLASSES):
    ...
    parser.add_argument("--encoder_max_seq_len",
                        type=int,
                        default=1536,
                        help="Max sequence length.")
    parser.add_argument("--decoder_max_seq_len",
                        type=int,
                        default=768,
                        help="Max sequence length.")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        "Global batch size for all training process. None for not check the size is valid. "
