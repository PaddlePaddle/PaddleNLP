...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", default="./data/ext_data", type=str, help="The path of data that you wanna save.")
    ...
    parser.add_argument("--splits", default=[0.6, 0.2, 0.2], type=float, nargs="*", help="The ratio of samples in datasets. [0.6, 0.2, 0.2] means 60% samples used for training, 20% for evaluation and 20% for test.")
    parser.add_argument("--task_type", choices=['ext', 'cls'], type=str, help="Select task type, ext for the extraction task and cls for the classification task, defaults to ext.")
