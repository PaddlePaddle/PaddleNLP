...
from uie.extraction.dataset_processer import TaskConfig
...
def load_eval_tasks(model, tokenizer, args):
    ...
    for task_config in task_configs:
        ...
        sel2record = SEL2Record(
            ...
            decoding_schema=task_config.decoding_format,
            map_config=MapConfig.load_from_yaml(task_config.sel2record),
            tokenizer=tokenizer
