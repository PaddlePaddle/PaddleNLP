...
=======
# 解语|TermTree（百科知识树）
>>>>>>> 39373e833e45201882e96c5dd9ae74c8eba3b8a3
...
2. 结合文本知识标注工具集（wordtag等）使用，用于文本词类特征生成、挖掘/解析pattern生成、文本一致性判定等等，参见[wordtag说明](../wordtag/README.md)。
3. 用于样本构建和优化：利用词类信息筛选&扩充样本、样本纠错、样本类别细化。
