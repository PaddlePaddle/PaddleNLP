...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str, default='./output/predict-base.txt', help='The file path where the infer result will be saved.')
    parser.add_argument('--train_data_path', type=str, default='./lic2021_baseline_dataset/data/train.txt', help='Specify the path to load train data.')
    parser.add_argument('--valid_data_path', type=str, default='./lic2021_baseline_dataset/data/valid.txt', help='Specify the path to load valid data.')
    parser.add_argument('--test_data_path', type=str, default='./lic2021_baseline_dataset/data/test.txt', help='Specify the path to load test data.')
