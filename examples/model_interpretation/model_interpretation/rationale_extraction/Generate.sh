...
do
    ...
    do
        ...
        do
            ...
            python3 ./code/NewP_Text_Generate.py \
                --pred_path $PRED_PATH \
                --save_path $SAVE_PATH \
                --task $TASK \
                --language $LANGUAGE \
            ...
            sh ./code/run_2_pred_${TASK}_per.sh $BASE_MODEL $INTER_MODE $LANGUAGE
            wait
            
            sh ./code/generate_evaluation_data.sh $BASE_MODEL $INTER_MODE $LANGUAGE $TASK
            wait
