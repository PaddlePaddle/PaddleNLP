...
class WikiLinkDB:
    ...
    def get(self, title):
        ...
        return [
            WikiLink(
                self._mention_trie.restore_key(text_id),
                self._title_trie.restore_key(title_id), link_prob)
    ...
    def build(dump_db, mention_db, out_file, pool_size, chunk_size):
        ...
        mention_trie = marisa_trie.Trie(text
    ...
    def _extract_wiki_links(title):
        ...
        for paragraph in _dump_db.get_paragraphs(title):
            for wiki_link in paragraph.wiki_links:
                ...
                links.append(
                    (wiki_link.text, _title_trie[link_title], link_prob))
