...
from modeling_pp import BloomForCausalLMPipe
...
class ModelArguments:
    ...
    model_type: Optional[str] = field(
        default="bloom", metadata={"help": "Only support for bloom pre-training for now."}
    )
    model_name_or_path: str = field(
        default="facebook/tiny-random-bloom",
        metadata={
    ...
    use_fused_rms_norm: bool = field(
        default=False,
        metadata={"help": "bloom, use_fused_rms_norm"},
    )
...
def main():
    ...
    if training_args.pipeline_parallel_degree > 1 and model_args.model_type == "bloom":
        model_class = BloomForCausalLMPipe
