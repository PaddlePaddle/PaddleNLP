...
from model_split_merge import split_model_parallel, construct_sub_model_name_or_path
...
def do_train(args):
    ...
    train_data_loader = paddle.io.DataLoader(
        ...
        num_workers=0,
        return_list=True,
        collate_fn=DataCollatorWithPadding(tokenizer=tokenizer, padding=True, max_length=args.max_seq_length, return_tensors='np'),
    )
    ...
    if args.mp_degree > 1:
        ...
        args.model_name_or_path = split_model_parallel(args.model_name_or_path, None, args.mp_degree, args.sharding_degree)
