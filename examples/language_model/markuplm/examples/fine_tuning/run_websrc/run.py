...
def evaluate(args, model, tokenizer, max_depth, prefix=""):
    ...
    dataset, examples, features = load_and_cache_examples(
        args, tokenizer, max_depth=max_depth, evaluate=True, output_examples=True
    )
    ...
    eval_dataloader = DataLoader(
        dataset, sampler=eval_sampler, batch_size=args.eval_batch_size, num_workers=args.dataloader_workers
    )
...
def main():
    ...
    # Required parameters
    parser.add_argument(
        "--train_file", default=None, type=str, required=True, help="json for training. E.g., train-v1.1.json"
    )
    parser.add_argument(
        "--predict_file",
        default=None,
