...
from paddlenlp.transformers import (  # ErnieForMaskedLM,; T5PretrainedModel,
    ErnieConfig,
    ErnieForPretraining,
...
MODEL_CLASSES = {
    ...
    "t5": (T5Config, T5Model, ErniePretrainingCriterion, T5Tokenizer),
}
...
def create_pretrained_dataset(
    ...
    print(train_valid_test_num_samples)
...
def do_train(args):
    ...
    tokenizer = tokenizer_class.from_pretrained(
        args.tokenizer_name_or_path, cls_token="[CLS]", bos_token="<s>", mask_token="[MASK]", sep_token="[SEP]"
    )
