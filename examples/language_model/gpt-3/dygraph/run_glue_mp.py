...
def run_evaluate(args, data_loader, model, criterion, iter_steps, log_writer, global_step, task_name="valid"):
    ...
    logger.info(
        ...
        % (task_name, global_step, eval_step, average_loss, iter_steps / (time.time() - local_time))
    )
...
def do_train(args):
    ...
    for step, batch in enumerate(train_data_loader()):
        ...
        if global_step % args.eval_freq == 0:
            ...
            pass
            # run_evaluate(
            #     args, valid_data_loader, model, criterion, args.eval_iters, log_writer, global_step, "valid"
            # )
