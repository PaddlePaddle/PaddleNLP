...
def parse_args(MODEL_CLASSES):
    ...
    parser.add_argument("--temperature", type=float, default=1.0, help="The temperature in each generation step.")
    # top-k sampling
    parser.add_argument("--topk", type=int, default=10, help="The hyper-parameter in top-k sampling..")
    # top-p sampling
    parser.add_argument("--topp", type=float, default=0.9, help="The hyper-parameter in top-p sampling.")
    # beam search
    parser.add_argument("--beam_size", type=int, default=1, help="The hyper-parameter in beam search.")
    parser.add_argument(
        "--save_inference_model_then_exist", type=str2bool, default=False, help="save_inference_model_then_exist"
    )
    parser.add_argument(
        "--fuse_transformer",
        type=str2bool,
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="Whether to enable fused_multi_transformer, need open fuse. This is only used for inference",
    )
