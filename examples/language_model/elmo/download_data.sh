...
wget https://paddlenlp.bj.bcebos.com/datasets/1-billion-word.tar.gz
...
wget https://paddlenlp.bj.bcebos.com/datasets/movie-review/sentence-polarity-dataset-v1.tar.gz
