...
def do_train(args):
    ...
    train_ds, dev_ds = load_dataset(args.dataset_name, splits=["train_v1", "dev_v1"])
    # train_ds, dev_ds = load_dataset(args.dataset_name, splits=["train_v2", "dev_v2"])
