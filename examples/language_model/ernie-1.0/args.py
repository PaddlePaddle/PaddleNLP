...
def parse_args(MODEL_CLASSES):
    ...
    parser.add_argument("--share_folder", type=str2bool, nargs='?', const=False, help="Set share folder to True, if data dir and output dir are mount from the same place for  multi machine.")
