...
# python -m paddle.distributed.launch --gpus "2,3,5,6" --log_dir ./unimo/finetune/merge9_train_epoch30/log run_gen.py \
#     --dataset_name=dureader_qg \
#     --train_file=/root/project/data/qa-dataset/qa-clean-qg-merge/merge9_train.json \
...
unset CUDA_VISIBLE_DEVICES
python -m paddle.distributed.launch --gpus "2,3,5,6" --log_dir ./unimo/finetune/merge9_train_epoch30_finetune_5e-6/log run_gen.py \
    --dataset_name=dureader_qg \
    ...
    --save_dir=./unimo/finetune/merge9_train_epoch30_finetune_5e-6/checkpoints \
    --output_path=./unimo/finetune/merge9_train_epoch30_finetune_5e-6/predict.txt \
    --logging_steps=100 \
    --save_steps=400 \
    --epochs=30 \
    --batch_size=16 \
