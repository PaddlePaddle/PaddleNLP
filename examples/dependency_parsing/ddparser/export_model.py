...
parser.add_argument("--encoding_model", choices=["lstm-pe", "ernie-3.0-medium-zh", "ernie-tiny", "ernie-gram-zh"], type=str, default="ernie-3.0-medium-zh", help="Select the encoding model.")
...
if __name__ == "__main__":
    ...
    # Load pretrained model if encoding model is ernie-3.0-medium-zh, ernie-tiny or ernie-gram-zh
