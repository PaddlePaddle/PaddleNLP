...
def get_semantic_embedding(data, model, tokenizer, batch_size=1):
    """
...
def build_index(data, model, tokenizer, batch_size):
    ...
    all_embeddings = []
    for idx, embeddings in enumerate(
            get_semantic_embedding(data, model, tokenizer, batch_size)):
...
if __name__ == "__main__":
    ...
    corpus_data = gen_data(args.corpus_file)
    ...
    final_index = build_index(
        corpus_data, model, tokenizer, batch_size=args.batch_size)
