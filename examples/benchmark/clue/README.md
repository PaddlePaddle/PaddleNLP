...
| --------------------- | ----- | ----- | ------- | ----- | ----- | ----------- | ----- | ----------- | ----- | ------------- |
| RoBERTa-wwm-ext-large | 76.20 | 59.50 | 62.10   | 84.02 | 79.15 | 90.79       | 82.03 | 66.17/88.65 | 83.38 | 75.79         |

AFQMC、TNEWS、IFLYTEK、CMNLI、OCNLI、CLUEWSC2020、CSL、CHID 和 C<sup>3</sup> 任务使用的评估指标均是 Accuracy，CMRC2018 任务使用的是 EM/F1。
