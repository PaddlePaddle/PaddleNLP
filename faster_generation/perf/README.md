...
|----------|-------------------|-----------------------------|-----------------------------|-------------------|----------------------------|----------------------------|
| OPT-125M | greedy search     | 91.98                       | 70.77                       | 229.72            | 2.50                       | 3.25                       |
|          | top_k = 1         | 95.47                       | 78.31                       | 258.73            | 2.71                       | 3.30                       |
|          | top_k = 4         | 92.52                       | 72.07                       | 251.66            | 2.72                       | 3.49                       |
|          | top_k = 8         | 94.32                       | 76.47                       | 241.22            | 2.56                       | 3.15                       |
|          | top_k = 16        | 94.33                       | 76.47                       | 241.22            | 2.56                       | 3.15                       |
|          | top_p = 0.4       | 111.76                      | 94.45                       | 334.33            | 2.99                       | 3.54                       |
| OPT-350M | greedy search     | 155.49                      | 119.97                      | 440.43            | 2.83                       | 3.67                       |
|          | top_k = 1         | 155.98                      | 119.35                      | 470.96            | 3.02                       | 3.95                       |
|          | top_k = 4         | 156.62                      | 119.22                      | 483.72            | 3.09                       | 4.06                       |
|          | top_k = 8         | 156.64                      | 123.68                      | 464.77            | 2.97                       | 3.76                       |
|          | top_k = 16        | 157.87                      | 118.13                      | 455.5             | 2.89                       | 3.86                       |
|          | top_p=0.4         | 177.31                      | 132.64                      | 492.14            | 2.78                       | 3.71                       |
| OPT-1.3b | greedy search     | 367.38                      | 228.59                      | 441.01            | 1.20                       | 1.93                       |
|          | top_k = 1         | 357.45                      | 228.94                      | 489.65            | 1.37                       | 2.14                       |
|          | top_k = 4         | 359.47                      | 231.96                      | 443.56            | 1.23                       | 1.91                       |
|          | top_k = 8         | 367.46                      | 228.29                      | 462.89            | 1.26                       | 2.03                       |
|          | top_k = 16        | 361.05                      | 230.13                      | 483.25            | 1.34                       | 2.10                       |
|          | top_p=0.4         | 389.72                      | 242.8                       | 517.19            | 1.33                       | 2.13                       |
