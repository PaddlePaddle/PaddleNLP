...
torch_model = PTVisualBertForQuestionAnswering.from_pretrained(
    "../checkpoint/" + torch_model_name)
...
torch_labels = torch.nn.functional.one_hot(
    torch.tensor(50), num_classes=3129).unsqueeze(0).to(
        torch.float32)  # Batch size 1, Num labels 3092
...
# ========================================================================================================
paddle_model = PDVisualBertForQuestionAnswering.from_pretrained(
    paddle_model_name, num_classes=3129)
...
paddle_labels = paddle.nn.functional.one_hot(
    paddle.to_tensor(50),
    num_classes=3129).astype(paddle.float32)  # Batch size 1, Num labels 3092
