...
struct GemmFpAIntBSplitK {
 ...
 public:
  ...
  static Status can_implement(
    ...
    if (isAMisaligned) {
      printf("  returning kErrorMisalignedOperand for A operand \n ");
      return Status::kErrorMisalignedOperand;
    }

    if (isBMisaligned) {
      printf("  returning kErrorMisalignedOperand for B operand \n");
      return Status::kErrorMisalignedOperand;
    }

    if (isCMisaligned) {
      printf("  returning kErrorMisalignedOperand for C operand \n");
      return Status::kErrorMisalignedOperand;
    }

    printf("  returning kSuccess \n");
