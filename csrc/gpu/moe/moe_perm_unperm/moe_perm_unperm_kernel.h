...
// template <phi::dtype type>
// struct ScalarType2CudaType;

// template <>
// struct ScalarType2CudaType<phi::dtype::float> {
//   using type = float;
// };
// template <>
// struct ScalarType2CudaType<phi::dtype::float16> {
//   using type = half;
// };
// template <>
// struct ScalarType2CudaType<phi::dtype::bfloat16> {
...
// // fp8
// template <>
// struct ScalarType2CudaType<phi::dtype::float8_e5m2> {
//   using type = __nv_fp8_e5m2;
// };
// template <>
// struct ScalarType2CudaType<phi::dtype::float8_e4m3fn> {
...
void CubKeyValueSorter::run(void* workspace, size_t const workspace_size,
  ...
  PD_CHECK(expected_ws_size <= workspace_size,
