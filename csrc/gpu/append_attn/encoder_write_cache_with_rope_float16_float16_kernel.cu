...
template void EncoderWriteCacheWithRopeKernel<paddle::float16, paddle::float16>(const paddle::Tensor& qkv, // [token_num, 3, num_head, head_dim] ([token_num, num_head + 2 * gqa_group_size, head_dim] if GQA)
