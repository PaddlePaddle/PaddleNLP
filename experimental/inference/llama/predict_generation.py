...
import numpy as np
import paddle
from modeling import LlamaForCausalLMInferenceModel
...
class Predictor(object):
    def __init__(self, args):
        ...
        self.model = LlamaForCausalLMInferenceModel.from_pretrained(args.model_name_or_path, config=self.config)
