...
* **2025.03.12 [PaddleNLP v3.0 Beta4](https://github.com/PaddlePaddle/PaddleNLP/releases/tag/v3.0.0-beta4)**：DeepSeek V3/R1/R1-distill, QwQ-32B 热门思考模型，全面支持。自研下一代通用信息抽取工具 PP-UIE 全新发布。支持8K长度信息抽取。全面支持**DeepSeek V3/R1满血版FP8、INT8、4比特量化推理，MTP投机解码**。首Token推理速度**提升37.4%**。FP8推理，单机输出**超1400 tokens/s**；4比特单机部署，输出**超2500 tokens/s**！发布统一推理部署镜像，热门模型一键部署。推理部署使用文档全面更新，体验全面提升！新增大模型 Embedding 训练，支持INF-CL超大batch size训练。MergeKit模型融合工具，缓解对齐代价。低资源训练全面优化。16G小显存可以流畅训练。
