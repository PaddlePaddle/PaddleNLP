...
* [2021-12-12] PaddleNLP 2.2版本已发布！新增预训练加速训推一体开发FasterERNIE、面向生成任务的高性能加速组件FasterGeneration正式推出！:tada:解语特色套件升级，更完善的词类知识标注工具WordTag与百科知识树使用体验，正式推出名词短语标注工具NPTag！:tada:更多详细升级信息请查看[Release Note](https://github.com/PaddlePaddle/PaddleNLP/releases/tag/v2.1.0)。
