...
For more details please refer to [Question Answering](./legacy/applications/question_answering) and [Document VQA](./legacy/applications/document_intelligence/doc_vqa).
...
For more details please refer to [Sentiment Analysis](./legacy/applications/sentiment_analysis).
...
For more details please refer to [Speech Command Analysis](./legacy/applications/speech_cmd_analysis).
...
For more super large-scale model pre-training details please refer to [GPT-3](./legacy/examples/language_model/gpt-3).
