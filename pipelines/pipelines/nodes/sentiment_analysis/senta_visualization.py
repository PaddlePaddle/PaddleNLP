...
class SentaVisualization(BaseComponent):
    ...
    def run(self, sr_save_path: str):
        ...
        self.vs.plot_aspect_with_opinion(sr.aspect_opinion, save_path, image_type="histogram", sentiment="all", top_n=8)
        ...
        self.vs.plot_aspect_with_opinion(sr.aspect_opinion_positives, save_path, image_type="wordcloud", sentiment="positive")
        img_dict["aspect_opinion_wc_pos"] = save_path
        save_path = os.path.join(img_save_dir, "aspect_opinion_hist_pos.png")
        self.vs.plot_aspect_with_opinion(sr.aspect_opinion_positives, save_path, image_type="histogram", sentiment="positive", top_n=8)
        ...
        self.vs.plot_aspect_with_opinion(sr.aspect_opinion_negatives, save_path, image_type="wordcloud", sentiment="negative")
        img_dict["aspect_opinion_wc_neg"] = save_path
        save_path = os.path.join(img_save_dir, "aspect_opinion_hist_neg.png")
        self.vs.plot_aspect_with_opinion(sr.aspect_opinion_negatives, save_path, image_type="histogram", sentiment="negative", top_n=8)
        ...
        self.vs.plot_aspect_with_sentiment(sr.aspect_sentiment, save_path, image_type="histogram", top_n=15, descend_aspects=sr.descend_aspects)
