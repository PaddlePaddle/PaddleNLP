...
from tests.testing_utils import argv_context_guard, load_test_config, update_params,run_command
    ...
    def llm_finetune(self, model_name: str, method: str):
        ...
        for json_file in  os.listdir(model_path):
            if json_file.endswith("json"):
                shutil.copyfile(
                    model_path + "/" + json_file, os.path.join(self.output_dir, json_file))
        ...
        if method=="ptq" or method=="gptq":
            ...
            quant_params.update({"model_name_or_path": os.path.join(self.output_dir,"llama_sft_ckpts"),
        ...
        if method=="lora":
            ...
            # Merge Lora Params
            merge_lora = load_test_config(self.config_path, "merge_lora_params")
            merge_lora_config = {
        ...
        if method=="pt":
            ...
            merge_tp_config = {
                "model_name_or_path": os.path.join(self.output_dir,"llama_pt_ckpts/")
            }
