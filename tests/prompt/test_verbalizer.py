...
class VerbalizerTest(unittest.TestCase):
    ...
    def test_normalize(self):
        ...
        self.assertAlmostEqual(self.default_verb.normalize(outputs)[0].sum().tolist(), 1, 6)
        self.assertAlmostEqual(self.default_verb.normalize(outputs)[1].sum().tolist(), 1, 6)
