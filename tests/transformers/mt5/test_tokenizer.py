...
class MT5TokenizationTest(TokenizerTesterMixin, unittest.TestCase):

    # T5 and MT5 use the same tokenizer
    ...
    def mt5_base_tokenizer(self):
        return T5Tokenizer.from_pretrained("google/mt5-small")
    ...
    def test_eos_treatment(self):
        tokenizer = self.mt5_base_tokenizer()
    ...
    def test_prepare_batch(self):
        ...
        self.assertEqual(expected_src_tokens, result)
    ...
    # overwritten from `test_tokenization_common` since MT5 has no max length
