...
class ErnieDocBPETokenizationTest(TokenizerTesterMixin, unittest.TestCase):

    tokenizer_class = ErnieDocBPETokenizer
    ...
    def test_sequence_builders(self):
        tokenizer = self.tokenizer_class.from_pretrained("ernie-doc-base-en")
