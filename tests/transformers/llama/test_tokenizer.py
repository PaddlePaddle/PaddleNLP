...
class LLaMATokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def get_tokenizer(self, **kwargs):
        ...
        return LLaMATokenizer.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_full_tokenizer(self):
        tokenizer = LLaMATokenizer(self.vocab_file, **self.special_tokens_map)
        text = "lower newer"
    ...
    def test_padding_if_pad_token_set_slow(self):
        tokenizer = LLaMATokenizer.from_pretrained(self.tmpdirname, pad_token="<pad>")
    ...
    def test_add_bos_token_slow(self):
        bos_token = "$$$"
        tokenizer = LLaMATokenizer.from_pretrained(self.tmpdirname, bos_token=bos_token, add_bos_token=True)
