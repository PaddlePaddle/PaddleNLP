...
from paddlenlp.transformers import GPTJTokenizer
...
class GPTTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def get_tokenizer(self, **kwargs):
        ...
        return GPTJTokenizer.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_full_tokenizer(self):
        tokenizer = GPTJTokenizer(self.vocab_file, self.merges_file, **self.special_tokens_map)
        text = "lower newer"
    ...
    def test_padding_if_pad_token_set_slow(self):
        tokenizer = GPTJTokenizer.from_pretrained(self.tmpdirname, pad_token="<pad>")
    ...
    def test_add_bos_token_slow(self):
        bos_token = "$$$"
        tokenizer = GPTJTokenizer.from_pretrained(self.tmpdirname, bos_token=bos_token, add_bos_token=True)
