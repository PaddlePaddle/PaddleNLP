...
from paddlenlp.transformers.roformerv2.tokenizer import RoFormerv2Tokenizer
...
class RoFormerv2TokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_chinese(self):
        tokenizer = RoFormerv2Tokenizer.from_pretrained(
            list(RoFormerv2Tokenizer.pretrained_init_configuration.keys())[0], use_jieba=True
        )
        # test jieba tokenizer in rofromerV2
