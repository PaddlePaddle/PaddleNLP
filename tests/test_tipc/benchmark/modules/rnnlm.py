...
class RNNLMBenchmark(BenchmarkBase):
    ...
    def add_args(args, parser):
        ...
        parser.add_argument(
            '--num_steps', type=int, default=35, help='num steps')
        parser.add_argument(
            '--num_layers', type=int, default=2, help='num_layers')
        parser.add_argument(
    ...
    def logger(self,
               ...
               ips=None,
               **kwargs):
        return paddle.callbacks.ProgBarLogger(
            log_freq=(self.num_batch // 10), verbose=3)
