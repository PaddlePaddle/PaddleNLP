...
def get_parser():
    ...
    parser.add_argument(
        '--seed', type=int, default=None, help='Random generator seed. ')

    parser.add_argument('--use_amp', action='store_true', help='Enable AMP. ')
    parser.add_argument(
        '--scale_loss', type=float, default=128, help='Loss scale. ')
    parser.add_argument(
        '--amp_level', type=str, default="O1", help='AMP LEVEL. O1 or O2. ')
    parser.add_argument(
        '--custom_black_list',
        type=str,
        nargs='+',
    ...
    parser.add_argument(
        '--max_steps', type=int, default=None, help='Maximum steps. ')
    parser.add_argument(
        '--epoch', type=int, default=10, help='Number of epochs. ')
...
def add_dataset_args(parser):
    ...
    parser.add_argument(
        '--data_dir', type=str, default=None, help='Path to data. ')
    parser.add_argument(
        '--pad_to_max_seq_len',
        action='store_true',
...
def add_optimization_args(parser):
    parser.add_argument(
        '--optimizer', type=str, default=None, help='Optimizer. ')
    parser.add_argument(
        '--learning_rate', type=float, default=0.25, help='Learning rate. ')
    parser.add_argument(
        '--lr_scheduler',
        type=str,
        default=None,
