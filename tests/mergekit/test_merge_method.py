...
class TestMergeMethod(unittest.TestCase):
    ...
    def test_slerp(self):
        ...
        expected_result = np.array(
            [
                [-0.6438969373703003, 0.5830116271972656, -0.6711448431015015, 0.6180949211120605, 0.3868336081504822],
                [0.7868756055831909, -0.7252881526947021, 1.0844330787658691, 0.08746132254600525, 0.436140239238739],
                [
                    1.1772856712341309,
                    -0.27655813097953796,
                    0.8154879212379456,
                ...
                [0.7415980100631714, 0.7202664613723755, -0.30045247077941895, 0.7167086601257324, 0.6924070119857788],
            ],
            dtype="float32",
        )
        self.assertTrue(np.array_equal(merged_tensor, expected_result))
