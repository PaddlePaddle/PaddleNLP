...
pt_arguments = {
    ...
    "output_dir": "./unified_checkpoint/checkpoints/llama_pt_ckpts",
...
def get_pt_arguments(pt_arguments):
    configs = {}

    train_args = copy.deepcopy(pt_arguments)
...
class TestUnifiedCheckpointSingle(TestMultipleGpus):
    def setUp(self):
        self.config = pt_arguments
        os.environ.update(environment_variables)

        file_ = "https://bj.bcebos.com/paddlenlp/datasets/examples/AdvertiseGen.tar.gz"
        input_dir = "unified_checkpoint/pt_input/"  # unified_checkpoint/pt/data
        ...
        self.rtol = 1e-7
        self.run_pt_file = "llm/finetune_generation.py"
        self.num_nodes = 1

    def runfirst(self, train_args):
        self.run_1gpu(self.run_pt_file, **train_args)
    ...
    def testDP1(self):
        remove_logs()
        remove_ckpt(pt_arguments["output_dir"])
...
class TestUnifiedCheckpointBase(TestMultipleGpus):
    ...
    def setUp(self):
        ...
        self.configs = get_pt_arguments(pt_arguments)
        os.environ.update(environment_variables)
    ...
    def runfrist(self, train_args):
        self.run_n1c8(self.run_pt_file, **train_args)
...
class TestUnifiedCheckpointOnN2C4(TestUnifiedCheckpointBase):
    ...
    def runfrist(self, train_args):
        self.run_n2c4(self.run_pt_file, **train_args)
