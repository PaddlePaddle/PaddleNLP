...
* 🔥 **2022.11.28 发布 [PaddleNLP v2.4.4](https://github.com/PaddlePaddle/PaddleNLP/releases/tag/v2.4.4)**
  * 💪 框架升级：新增[**Huggingface Hub集成**](https://huggingface.co/)，将逐步支持Model，Tokenizer，Taskflow直接从Huggingface Hub加载；[**小样本 Prompt API**](./docs/advanced_guide/prompt.md)升级，支持PET算法实现；
  * 💎 NLP工具：[**NLP 流水线系统 Pipelines**](./pipelines)检索能力再加强，支持[Ernie-Search](./pipelines/API.md)；发布[**SimpleServing**](./model_zoo/ernie-health/cblue/deploy/serving/SimpleServing/README.md), 支持 Taskflow、预训练模型快速部署
