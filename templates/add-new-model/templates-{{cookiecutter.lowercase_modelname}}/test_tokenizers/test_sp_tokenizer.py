...
class {{cookiecutter.camelcase_modelname}}TokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        tokenizer = {{cookiecutter.camelcase_modelname}}Tokenizer(vocab_file=EN_VOCAB,
                                    sentencepiece_model_file=EN_SENTENCEPIECE,
                                    unk_token="<unk>")
        tokenizer.save_pretrained(self.tmpdirname)

    def get_tokenizer(self, **kwargs) -> PretrainedTokenizer:
        return {{cookiecutter.camelcase_modelname}}Tokenizer.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_full_tokenizer(self):
        tokenizer = {{cookiecutter.camelcase_modelname}}Tokenizer.from_pretrained(self.tmpdirname)
    ...
    def test_sequence_builders(self):
        tokenizer = self.tokenizer_class.from_pretrained("{{cookiecutter.checkpoint_identifier}}")
