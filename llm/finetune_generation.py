...
def main():
    ...
    if training_args.pipeline_parallel_degree > 1:
        ...
        model_config.long_sequence_strategy_name = "NTKScalingRotaryEmbedding"#"NTKScalingRotaryEmbedding"  #RotaryEmbedding#LinearScalingRotaryEmbedding#v#AttentionWithLinearBias
        ...
        if model_config.alibi:
            ...
            ,"max_position_embeddings":model_config.max_position_embeddings,"base":10000,"scaling_factor":0.8,"position_encoding_2d":position_encoding_2d}
