...
class PreTrainingArguments(TrainingArguments):
    ...
    fused_linear: bool = field(
        default=False,
        metadata={
            "help": "Enable fused_gemm_epilogue_pass, which should replace add_n_op with add_op for gradients accumulation."
        },
    )
...
def main():
    ...
    config.fused_linear = training_args.fused_linear
    config.fused_linear_param_grad_add = training_args.fused_linear_param_grad_add
