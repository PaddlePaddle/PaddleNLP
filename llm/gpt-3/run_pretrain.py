...
class DataArguments:
    ...
    cache_dir: str = field(default=None, metadata={"help": "The dir of the cached dataset."})
...
def create_pretrained_dataset(
    ...
    def build_dataset(index, name):
        dataset = GPTDataset(
            file_prefix=os.path.join(data_args.cache_dir, os.path.basename(input_prefix)),
...
def main():
    ...
    if data_args.cache_dir is None:
        data_args.cache_dir = data_args.input_dir
    else:
