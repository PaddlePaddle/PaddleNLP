...
export LD_LIBRARY_PATH=/opt/output/work_dir/anaconda3/envs/wht_final/lib/python3.9/site-packages/paddlenlp_ops-0.0.0-py3.9-linux-x86_64.egg:$LD_LIBRARY_PATH
...
python -u  -m paddle.distributed.launch --devices "0,1,2,3,4,5,6,7" export_model.py \
    ...
    --inference_model 1 \
    --block_attn 1 \
    --output_path ./deepseek-v3-inference \
    --dtype bfloat16 \
