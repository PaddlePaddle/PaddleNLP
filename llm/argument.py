...
class ModelArgument:
    ...
    lora_plus: bool = field(default=False, metadata={"help": "Whether to use LoRA+ technique"})
    lora_B_scale: int = field(default=16, metadata={"help": "Lora B scale in LoRA+ technique"})
