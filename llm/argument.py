...
class ModelArgument:
    ...
    qconfig_path: str = field(default=None, metadata={"help": "Quantization algorithm for each matrix."})
    lqlora_state_dict_path: str = field(default=None, metadata={"help": "Initialize lq-lora state dict."})
