...
#python test_faiss_gpu.py --only_recon --checkpoint_path checkpoints/ckpt_quant_pt_1000/checkpoint-500 --output ckpt --quant_bits_opt 8 --quant_stage 2
python test_faiss.py --ref_checkpoint_path checkpoints/ckpt_quant_pt_1000/checkpoint-500 --checkpoint_path checkpoints/ckpt_quant_pt_1000/checkpoint-1000-ori --output ckpt 
