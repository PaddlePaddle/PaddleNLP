...
# serving port
export HEALTH_HTTP_PORT=${HEALTH_HTTP_PORT:-"8110"}
export METRICS_HTTP_PORT=${METRICS_HTTP_PORT:-"8722"}
export SERVICE_GRPC_PORT=${SERVICE_GRPC_PORT:-"8811"}
export SERVICE_HTTP_PORT=${SERVICE_HTTP_PORT:-"9965"}
export INTER_PROC_PORT=${INTER_PROC_PORT:-"8813"}
