...
class TokenProcessor(object):
    ...
    def __init__(self, cfg):
        ...
        self.queue_id = paddle.full(shape=[1], fill_value=1, dtype="int32")
        ...
        while True:
            try:
                ...
                if self.is_speculate_decoding:
                    ...
                    get_output(self.output_tokens, self.queue_id, rank_id, is_blocking)
        ...
        while self._is_running:
            try:
                ...
                if self.is_speculate_decoding:
                    ...
                    get_output(self.output_tokens, self.queue_id, rank_id, self._is_blocking)
