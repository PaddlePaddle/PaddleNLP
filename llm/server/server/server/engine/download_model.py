...
def parse_arguments():
    ...
    parser.add_argument('-d', '--dir', default='downloads',
                       help="save dir")
    parser.add_argument('-m', '--model_name', default='DeepSeek-R1/DeepSeek-R1-Distill-Llama-8B',
                       help="model_name")
...
def download_from_txt(base_url, save_dir, model_name):
    ...
    try:
        ...
        raise Exception(f"Failed to get model {model_name} from {base_url}, please recheck the model name from https://github.com/PaddlePaddle/PaddleNLP/blob/develop/llm/docs/predict/inference.md")
