...
class InferenceEngine(object):
    ...
    def _init_predictor(self):
        ...
        # model.json when using PIR, model.pdmodel when not using PIR
        ...
        if self.mp_degree > 1:
            ...
            if self.config.distributed_config_path:
                ...
                logger.warning("Use default distributed config, please set env DISTRIBUTED_CONFIG")
