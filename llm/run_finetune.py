...
def main():
    ...
    quantization_config = dict(
        ...
        qlora_weight_blocksize=model_args.weight_blocksize,
        qlora_weight_double_quant=model_args.weight_double_quant,
        qlora_weight_double_quant_block_size=model_args.weight_double_quant_block_size,
    )
