...
task_name="gbsz32_steps4_pp1tp2dp4zero2"
dir_name="cost_model_check"
sub_dir_name="layer4"

export HF_ENDPOINT=https://hf-mirror.com
rm -rf output/$dir_name/$task_name/$sub_dir_name
rm -rf "output/$dir_name/$task_name/$sub_dir_name""_log"
...
LAUNCHER="${LAUNCHER} --log_dir output/$dir_name/$task_name/$sub_dir_name""_log ${TRAINER} --output_dir "./output""
