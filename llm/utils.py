...
def dybatch_preprocess(tokenizer, texts: list[str], max_length: int, pre_caches_length: int = 0):
    ...
    for i in range(bs):
        position_ids[i, : pre_caches_length + seq_len[i]] = paddle.arange(seq_len[i])
