...
- [Triton](https://openai.com/index/triton/)：Triton作为高效的算子开发工具，在我们的系统中得到大量应用。
- [sglang](https://github.com/sgl-project/sglang), [vLLM](https://github.com/vllm-project/vllm)：MoE和Fp8的算子为我们的系统优化带来了重要参考
