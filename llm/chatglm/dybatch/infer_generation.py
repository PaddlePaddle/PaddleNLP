...
from paddlenlp.transformers import AutoTokenizer, ChatGLMConfig
...
class Predictor(object):
    def __init__(self, args):
        ...
        self.config = ChatGLMConfig.from_pretrained(args.model_dir)
                    ...
                    paddle.to_tensor(
                        np.zeros(
                            (
                                ...
                                args.src_length + args.tgt_length,
        ...
        self.tgt_generation_mask = paddle.zeros(
            shape=[args.batch_size, 1, 1, args.src_length + args.tgt_length],
            dtype="float16",
        )
    ...
    def preprocess(self, input_text):
        ...
        inputs["attention_mask"] = self.attention_mask.numpy()
        inputs["tgt_generation_mask"] = self.tgt_generation_mask.numpy()
    ...
    def infer(self, inputs):
        ...
        for k, v in inputs.items():
            print(k, "----> type", v.dtype, " shape ", v.shape)
