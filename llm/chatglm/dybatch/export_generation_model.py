...
from utils import generate_rank_mapping, get_infer_model_path, get_state_dict
...
def main():
    ...
    config = ChatGLMConfig.from_pretrained(args.model_name_or_dir)
    tokenizer = ChatGLMTokenizer.from_pretrained(args.model_name_or_dir)
    ...
    model = ChatGLMForConditionalGenerationDyBatch.from_pretrained(
        args.model_name_or_dir,
        config=config,
        dtype=args.model_dtype,
    )
    state_dict = get_state_dict(args.model_name_or_dir, ChatGLMForConditionalGenerationDyBatch, model.config)
    ...
    input_spec = [
        ...
        paddle.static.InputSpec(shape=[None, None, None], dtype="int64", name="position_ids"),  # position_ids
        ...
        paddle.static.InputSpec(shape=[None, 2, 1], dtype="int64", name="tgt_pos"),  # tgt_pos
        paddle.static.InputSpec(
