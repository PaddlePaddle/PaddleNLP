...
"""
This py is used to convert the second part of miniGPT4 into a static graph.

python3.8  export_llama_for_minigpt4.py \
--model_name_or_path /zhoukangkang/2023-06-06minigpt/whole_part/llama-13b-fp16/ \
--output_path /zhoukangkang/2023-06-06minigpt/whole_part/miniGPT4-second-part_kaiyuan_fp16 \
--dtype float16 \
    --inference_model \
    --model_prefix=llama > out.txt
"""
