...
class MoEHybridParallelClipGrad:
    ...
    def _dygraph_clip(self, params_grads):
        ...
        # assert (
        #     sum_square_dist_moe_fp16
        #     or sum_square_dist_moe_bf16
        #     or sum_square_dist_moe_fp32
        #     or sum_square_not_dist_moe_fp16
        #     or sum_square_not_dist_moe_bf16
        #     or sum_square_not_dist_moe_fp32
        # ), f"no moe param found"
