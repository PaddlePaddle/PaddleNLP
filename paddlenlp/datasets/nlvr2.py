...
class NLVR2(DatasetBuilder):
    ...
    SPLITS = {
        'train': META_INFO(
            os.path.join('annotations', 'train.json'), '8482649e6c7be8644ff6e6fe1c6f85d0'),
        'dev': META_INFO(
            os.path.join('annotations', 'dev.json'), 'e0423ecad966f61a6548bacddb79edc8'),
        'test1': META_INFO(
            os.path.join('annotations', 'test1.json'), '9d9e0ff95ea7df582dde7721c8d77b3d'),
    }
    ...
    def _read(self, filename, split):
        ...
        for index, item in enumerate(items):
            ...
            sample["feature_path_0"] = "{}img{}.png.npy".format(item["identifier"][:-1], 0)
            sample["feature_path_1"] = "{}img{}.png.npy".format(item["identifier"][:-1], 1)
