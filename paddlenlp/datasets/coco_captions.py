...
class COCOCaptions(DatasetBuilder):
    ...
    SPLITS = {
        'train': META_INFO(
            os.path.join('annotations', 'captions_train2014.json'), 'abfcc336d66eec2e8c453600cc1db939'),
        'val': META_INFO(
            os.path.join('annotations', 'captions_val2014.json'), '41a3e90178948b2ba004175080277e35'),
    }
    ...
    def _read(self, filename, split):
        ...
        for index, iminfo in enumerate(items):
            ...
            rest_anns = coco.loadAnns([i for i in coco.getAnnIds(imgIds=image_id) if i != iminfo['id']])
