    ...
    def sample(
        ...
        **model_kwargs
        ...
        def _post_process_(
            ...
            try:
                from paddlenlp_ops import fused_update_inputs

                print("test gaoziyuanfgaoziyuan fused_update_inputs!")
                fused_update_inputs(
                    stop_flags,
                ...
                from paddlenlp_ops import set_stop_value_multi_ends_v2, update_inputs
