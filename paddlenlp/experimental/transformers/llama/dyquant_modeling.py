...
__all__ = ["LlamaDyquantInferenceModel", "LlamaForCausalLMDyquantInferenceModel"]
...
@register_base_model
class LlamaDyquantInferenceModel(LlamaPretrainedModel):
    """
    ...
    def set_state_dict(self, state_dict):
        ...
        for idx in range(self.config.num_hidden_layers):
            ...
            qkv_quanted_weight_tensor, qkv_weight_scale_tensor = weight_quantize(qkv_weight_tensor, algo=self.quant_algo)
            ...
            ffn1_quanted_weight_tensor, ffn1_weight_scale_tensor = weight_quantize(ffn1_weight_tensor, algo=self.quant_algo)
...
class LlamaForCausalLMDyquantInferenceModel(GenerationInferenceModel, LlamaForCausalLM):
    """
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = LlamaDyquantInferenceModel(config)
