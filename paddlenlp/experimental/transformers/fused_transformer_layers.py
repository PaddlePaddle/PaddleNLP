...
class FusedMultiTransformerFP8Config:
    """
    FusedMultiTransformerFP8Config
    """
    ...
    def __init__(
        ...
        ffn1_0_weight_scale_attrs=None,
        ...
        self.ffn1_0_weight_scale_attrs = ffn1_0_weight_scale_attrs
...
class FusedBlockMultiTransformerFP8(Layer):
    def __init__(self, config: FusedMultiTransformerFP8Config):
        ...
        super().__init__()
        self.config = config
        self.act_scales = config.act_scales
        self.weight_scales = config.weight_scales
