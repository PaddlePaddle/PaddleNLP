...
class LayoutLMTokenizer(BertTokenizer):
    ...
    pretrained_resource_files_map = {
        "vocab_file": {
            ...
            "https://paddlenlp.bj.bcebos.com/models/transformers/layoutlm_base-uncased/layoutlm_base-uncased-vocab.txt",
            "layoutlm-large-uncased":
            "https://paddlenlp.bj.bcebos.com/models/transformers/layoutlm_large-uncased/layoutlm-large-uncased-vocab.txt",
        }
    }
