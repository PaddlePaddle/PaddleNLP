...
class LayoutLMTokenizer(BertTokenizer):
    ...
    pretrained_resource_files_map = {
        "vocab_file": {
            ...
            "https://paddlenlp.bj.bcebos.com/models/transformers/layoutlm/layoutlm_base-uncased/vocab.txt",
            "layoutlm-large-uncased":
            "https://paddlenlp.bj.bcebos.com/models/transformers/layoutlm/layoutlm_large-uncased/vocab.txt",
        }
    }
