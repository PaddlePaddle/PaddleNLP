...
from paddlenlp.transformers.fused_multi_transformer_fine_grained_chatglm import (
...
class ChatGLMForConditionalGenerationDyBatch(GenerationDyBatch, ChatGLMPretrainedModel):
    def __init__(self, config: ChatGLMConfig):
        super(ChatGLMForConditionalGenerationDyBatch, self).__init__(config)
