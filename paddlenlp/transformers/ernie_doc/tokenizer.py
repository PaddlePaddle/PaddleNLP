...
class ErnieDocBPETokenizer(BPETokenizer):
    ...
    def __init__(
            ...
            cls_token: str = "[CLS]",
            mask_token: str = "[MASK]",
            # deprecated: this field will be removed after version<2.3.8>
            vocab_file: Optional[str] = None,
            **kwargs):

        super(ErnieDocBPETokenizer, self).__init__(vocab_file=encoder_json_path,
                                                   merges_file=vocab_bpe_path,
                                                   unk_token=unk_token,
                                                   sep_token=sep_token,
                                                   pad_token=pad_token,
                                                   cls_token=cls_token,
        ...
        # TODO(wj-Mcat): to be removed after version<2.3.8>
        ...
        # re-init the kwargs with the correct kwargs
        # refer to: https://github.com/PaddlePaddle/PaddleNLP/issues/3109
        self.init_kwargs = dict(
            ...
            mask_token=mask_token,
            vocab_file=
            None,  # deprecated: this field will be removed after version<2.3.8>
            **kwargs)
