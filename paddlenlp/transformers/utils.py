...
def get_checkpoint_shard_files(
    ...
    for shard_filename in tqdm.tqdm(shard_filenames, desc="Downloading shards", disable=not show_progress_bar):
        try:
            cached_filename = get_file(pretrained_model_name_or_path, [shard_filename], subfolder, cache_dir=cache_dir,
                                      from_aistudio=from_aistudio, from_hf_hub=from_hf_hub)
            # if from_aistudio:
