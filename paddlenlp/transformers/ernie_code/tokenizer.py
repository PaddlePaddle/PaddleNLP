...
# Copyright 2023 The ErineCode Authors
#
...
class ErnieCodeTokenizer(AlbertEnglishTokenizer):
    """
        ...
        **kwargs
        ...
        if extra_ids > 0 and len(additional_special_tokens) == 0:
            ...
            if extra_tokens != extra_ids:
                raise ValueError(
                    f"Both extra_ids ({extra_ids}) and additional_special_tokens ({additional_special_tokens}) are provided to ErnieCodeTokenizer. "
    ...
    def __call__(
        ...
        **kwargs
        ...
        return super(ErnieCodeTokenizer, self).__call__(
            text=text,
            text_pair=text_pair,
