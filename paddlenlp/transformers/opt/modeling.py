        ...
        mappings = {
            ...
            "attn_param_names": {
                "qkv_proj": lambda layer_id: re.sub(
                    r"\d+", str(layer_id), "decoder.layers.0.self_attn.qkv_proj.weight"
                ),
                "q_proj": lambda layer_id: re.sub(r"\d+", str(layer_id), "decoder.layers.0.self_attn.q_proj.weight"),
                "k_proj": lambda layer_id: re.sub(r"\d+", str(layer_id), "decoder.layers.0.self_attn.k_proj.weight"),
                "v_proj": lambda layer_id: re.sub(r"\d+", str(layer_id), "decoder.layers.0.self_attn.v_proj.weight"),
            },
