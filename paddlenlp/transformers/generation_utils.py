...
class GenerationMixin(object):
    ...
    def greedy_search(self, input_ids, logits_processors, max_length, pad_token_id, eos_token_id, **model_kwargs):
        ...
        while cur_len < max_length:
            ...
            cur_len += 1
            input_ids = paddle.concat([paddle.cast(input_ids, dtype='int64'), next_tokens], axis=1)
        ...
        **model_kwargs
        ...
        while cur_len < max_length:
            ...
            input_ids = paddle.concat(
                [paddle.index_select(paddle.cast(input_ids, dtype='int64'), beam_idx), beam_next_tokens.unsqueeze(-1)], axis=-1
            )
        ...
        while cur_len < max_length:
            ...
            for beam_group_idx in range(num_beam_groups):
                ...
                group_input_ids = paddle.concat(
                    [paddle.index_select(paddle.cast(group_input_ids, dtype='int64'), index=beam_idx), beam_next_tokens.unsqueeze(-1)], axis=-1
                )
