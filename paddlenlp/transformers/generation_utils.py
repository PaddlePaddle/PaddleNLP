...
class GenerationMixin(object):
    ...
    @staticmethod
    def update_model_kwargs_for_generation_dybatch(cache, just_decoder, next_tokens, eos_token_id, model_kwargs):
        if cache is None:
    ...
    def sample_dybatch(
        ...
        **model_kwargs,
        ...
        def _post_process_(outputs, top_p, temperature, step_idx_ori, model_kwargs):
            ...
            model_kwargs = self.update_model_kwargs_for_generation_dybatch(
