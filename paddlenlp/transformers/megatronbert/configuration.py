...
""" MegatronBERT model configuration"""
...
__all__ = ["MEGATRONBERT_PRETRAINED_INIT_CONFIGURATION", "MegatronBertConfig", "MEGATRONBERT_PRETRAINED_RESOURCE_FILES_MAP"]

MEGATRAONBERT_PRETRAINED_INIT_CONFIGURATION = {
   "megatronbert-cased": {
...
class MegatronBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`MegatronBertModel`] or a [`TFBertModel`]. It is used to
 ...
 "megatronbert-cased": "http://bj.bcebos.com/paddlenlp/models/transformers/"
            "megatron-bert/megatronbert-cased/model_state.pdparams",
            "megatronbert-uncased": "http://bj.bcebos.com/paddlenlp/models/transformers/"
            "megatron-bert/megatronbert-cased/model_state.pdparams",            Dimensionality of the encoder layers and the pooler layer.
