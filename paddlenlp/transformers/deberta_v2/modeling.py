...
class DebertaV2PreTrainedModel(PretrainedModel):
    ...
    def _get_name_mappings(cls, config):
        ...
        model_mappings = [
            ...
            ["encoder.conv.conv.weight", "encoder.conv.conv.weight"],
            ["encoder.conv.conv.bias", "encoder.conv.conv.bias"],
            ["encoder.conv.LayerNorm.weight", "encoder.conv.LayerNorm.weight"],
            ["encoder.conv.LayerNorm.bias", "encoder.conv.LayerNorm.bias"],
        ]
