...
class DebertaV2Tokenizer(AlbertEnglishTokenizer):
    """
    Constructs a Deberta tokenizer based on SentencePiece .
    ...
    pretrained_resource_files_map = {
        "sentencepiece_model_file": {
            "Deberta-v3-base": "https://huggingface.co/microsoft/deberta-v3-base/resolve/main/spm.model",
        },
    }

    pretrained_init_configuration = {
        "Deberta-v3-base": {"do_lower_case": False},
    }
    ...
    def __call__(
        ...
        **kwargs
        ...
        return super(DebertaV2Tokenizer, self).__call__(
            text=text,
            text_pair=text_pair,
