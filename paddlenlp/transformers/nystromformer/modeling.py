...
__all__ = [
    ...
    "NystromformerSelfAttention", "NystromformerSelfOutput",
    "NystromformerAttention", "NystromformerIntermediate", "NystromformerOutput",
    "NystromformerLayer", "NystromformerEncoder",
...
class NystromformerSelfAttention(nn.Layer):
    ...
    def forward(self, hidden_states, attention_mask=None, output_attentions=False):
        ...
        query_layer = query_layer / paddle.sqrt(paddle.sqrt(self.attention_head_size))
        key_layer = key_layer / paddle.sqrt(paddle.sqrt(self.attention_head_size))
    ...
    def forward(
        ...
        if token_type_ids is None:
            if hasattr(self.embeddings, "token_type_ids"):
                ...
                token_type_ids = paddle.zeros(input_shape, dtype=paddle.int64)
        extended_attention_mask: paddle.Tensor = get_extended_attention_mask(attention_mask, input_shape)
...
class NystromformerForSequenceClassification(NystromformerPretrainedModel):
    ...
    def from_pretrained(self, pretrained_model_name_or_path, *args, **kwargs):
        ...
        print("NystromformerModel is loaded with pretrained parameters, "
