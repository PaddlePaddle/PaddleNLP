...
class ExpertsGroupGemmNode:
    ...
    def bwd_dowm_input(self, expert_w2, unzipped_grad, unzipped_scale, tokens_per_expert):
        ...
        deep_gemm.gemm_fp8_fp8_bf16_nt((unzipped_grad[0], unzipped_scale[0]), (bw_w2_quant[0], bw_w2_scale[0]), dx_0)

        dx_1 = paddle.empty([seq_len, H2], dtype=paddle.bfloat16)
        deep_gemm.gemm_fp8_fp8_bf16_nt((unzipped_grad[1], unzipped_scale[1]), (bw_w2_quant[1], bw_w2_scale[1]), dx_1)

        dx_2 = paddle.empty([seq_len, H2], dtype=paddle.bfloat16)
        deep_gemm.gemm_fp8_fp8_bf16_nt((unzipped_grad[2], unzipped_scale[2]), (bw_w2_quant[2], bw_w2_scale[2]), dx_2)

        dx_3 = paddle.empty([seq_len, H2], dtype=paddle.bfloat16)
        deep_gemm.gemm_fp8_fp8_bf16_nt((unzipped_grad[3], unzipped_scale[3]), (bw_w2_quant[3], bw_w2_scale[3]), dx_3)
    ...
    def backward(self, out_grad, out_grad_scale, tokens_per_expert, dispatched_indices):
        ...
        # dx
        dx = self.bwd_gate_up_input(do1, expert_w1, tokens_per_expert)
