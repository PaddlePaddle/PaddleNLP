...
class PretrainedConfig:
    ...
    def _get_config_dict(
        ...
        filenames = [configuration_file, LEGACY_CONFIG_NAME] if configuration_file == CONFIG_NAME else [configuration_file, CONFIG_NAME, LEGACY_CONFIG_NAME]
        
        resolved_config_file = get_file(pretrained_model_name_or_path, filenames, 
                                        subfolder, cache_dir=cache_dir, 
                                        force_download=force_download, from_aistudio=from_aistudio, 
