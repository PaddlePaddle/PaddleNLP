...
from .configuration import T5_PRETRAINED_RESOURCE_FILES_MAP, T5_PRETRAINED_INIT_CONFIGURATION, T5Config
...
class T5EncoderModel(T5PretrainedModel):
    ...
    def __init__(self, config: T5Config):
        ...
        encoder_config.use_cache = False
        encoder_config.is_encoder_decoder = False
        self.shared = nn.Embedding(encoder_config.vocab_size,
