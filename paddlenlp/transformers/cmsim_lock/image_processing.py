...
"""Image processor class for CMSIMLock."""
...
__all__ = ["CMSIMLockImageProcessor"]


class CMSIMLockImageProcessor(BaseImageProcessor):
    r"""
    Constructs a CMSIMLock image processor.
