    ...
    def forward(self, args):
        ...
        if self.config.num_nextn_predict_layers > 0:
            ...
            if self.sequence_parallel:
                ...
                # print("==== inputs_embeds after transpose =====")
                # print(inputs_embeds)
...
class DeepseekV2DecoderLayerPipe(DeepseekV2DecoderLayer):
    def forward(self, args):
        ...
        if self.config.num_nextn_predict_layers > 0:
            # print("==== hidden_states in DecoderLayerPipe ====")
            # print(hidden_states)
            ...
            # print(f"==== batch_size_mtp:{batch_size_mtp} inputs_embeds_mtp, hidden_states ====")
            # print(inputs_embeds_mtp)
            # print(hidden_states)
