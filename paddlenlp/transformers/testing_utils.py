...
if is_paddle_available():
    ...
    paddle_device = "cuda" if paddle.is_compiled_with_cuda() else "cpu"
else:
    paddle_device = None
...
def require_paddle_gpu(test_case):
    ...
    return unittest.skipUnless(paddle_device == "cuda", "test requires CUDA")(test_case)
...
def nested_simplify(obj, decimals=3):
    ...
    if isinstance(obj, tuple):
        ...
        return obj
    elif is_paddle_available() and isinstance(obj, paddle.Tensor):
