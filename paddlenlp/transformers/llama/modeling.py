    ...
    def _get_name_mappings(cls, config: LlamaConfig) -> list[StateDictNameMapping]:
        ...
        for layer_index in range(config.num_hidden_layers):
            layer_mappings = [
                ...
                [f"layers.{layer_index}.self_attn.q_proj.bias"],
                [f"layers.{layer_index}.self_attn.k_proj.bias"],
                [f"layers.{layer_index}.self_attn.v_proj.bias"],
                [f"layers.{layer_index}.self_attn.o_proj.bias"],
                [f"layers.{layer_index}.self_attn.rotary_emb.inv_freq"],
                [f"layers.{layer_index}.mlp.gate_proj.weight", None, "transpose"],
                [f"layers.{layer_index}.mlp.down_proj.weight", None, "transpose"],
                [f"layers.{layer_index}.mlp.up_proj.weight", None, "transpose"],
                [f"layers.{layer_index}.mlp.gate_proj.bias"],
                [f"layers.{layer_index}.mlp.down_proj.bias"],
                [f"layers.{layer_index}.mlp.up_proj.bias"],
