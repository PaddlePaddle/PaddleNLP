...
def add_quant_mapping(name_action_mappings):
    mapping_keys = name_action_mappings.keys()
    for key in mapping_keys:
        quant_key = key.replace("weight", "quant_weight")
        fn = name_action_mappings[key]
...
class ConversionMixin:
    ...
    def get_tensor_parallel_convert_actions(
        ...
        if config.quantization_config.is_weight_quantize():
            name_action_mappings = add_quant_mapping(name_action_mappings)
