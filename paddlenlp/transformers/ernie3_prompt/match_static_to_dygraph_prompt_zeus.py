...
def match_encoder_param(convert_parameter_name_dict, layer_num=6):
    ...
    convert_parameter_name_dict[
        "layer_norm.weight"] = "server_post_encoder_layer_norm_scale"
    convert_parameter_name_dict[
        "layer_norm.bias"] = "server_post_encoder_layer_norm_bias"
    return convert_parameter_name_dict
...
def match_mlm_parameter(convert_parameter_name_dict):
    ...
    convert_parameter_name_dict["lm_head.lm_out.weight"] = "server_nlg_mask_lm_out_fc.w_0"
    convert_parameter_name_dict["lm_head.lm_out.bias"] = "server_nlg_mask_lm_out_fc.b_0"
    return convert_parameter_name_dict
...
if __name__ == "__main__":
    ...
    convert_parameter_name_dict = match_encoder_param(
        convert_parameter_name_dict, layer_num=48)
    ...
    convert_static_to_dygraph_params(
        dygraph_params_save_path='model_state.pdparams',
        static_params_dir='/home/gonel_pre/paddlenlp/transformers/ernie3_prompt/final_model.bk_defuse',
        static_to_dygraph_param_name=convert_parameter_name_dict,
        vocab_size_output=46256, # default to 46256
