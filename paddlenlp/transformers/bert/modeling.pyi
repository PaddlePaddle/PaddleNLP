...
class BertForSequenceClassification(BertPretrainedModel):
    ...
    @staticmethod
    def from_pretrained(cls, pretrained_model_name_or_path: str, cache_dir: str | None = None, num_labels: int | None = 2, classifier_dropout: float | None = None, config: Optional[BertConfig] = None, *args, **kwargs) -> BertForQuestionAnswering: ...
...
class BertForMultipleChoice(BertPretrainedModel):
    ...
    def forward(self, input_ids, token_type_ids: Tensor | None = ..., position_ids: Tensor | None = ..., attention_mask: Tensor | None = ..., labels: Tensor | None = ..., output_hidden_states: bool = ..., output_attentions: bool = ..., return_dict: bool = ...): ...
    @staticmethod
    def from_pretrained(cls, pretrained_model_name_or_path: str, cache_dir: str | None = None, num_choices: int | None = 2, classifier_dropout: float | None = None, config: Optional[BertConfig] = None, *args, **kwargs) -> BertForQuestionAnswering: ...
