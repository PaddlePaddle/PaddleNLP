...
class MlpNode:
    ...
    @paddle.no_grad()
    def backward(self, hidden_states_out_grad):  # 改动
        if DSV3_USE_FP8_GROUP_GEMM:
            # zip_grad
            unzipped_grad, probs_grad = self.zip_node.backward(  # 加了个probs_grad
            ...
            expert_out = self.experts_group_gemm_node.backward(
