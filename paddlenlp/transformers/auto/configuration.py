...
class AutoConfig(PretrainedConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, *model_args, **kwargs):
        ...
        config_file = get_file(pretrained_model_name_or_path, [cls.config_file, cls.legacy_config_file], 
                               subfolder, cache_dir=cache_dir,  from_hf_hub=from_hf_hub, from_aistudio=from_aistudio)
        print(config_file)
