...
def sequence_mask(seq_ids, valid_lengths):
    ...
    Args:
        seq_ids (Tensor): The whole sequence index, a tensor with shape `[batch_size, sequence_length]`.
        valid_lengths (Tensor): The valid length of every sequence, a tensor with shape `[batch_size]`
