...
class Trainer:
    ...
    def _load_optimizer_and_scheduler(self, checkpoint):
        ...
        if opt_state_dict and os.path.isfile(os.path.join(checkpoint, SCHEDULER_NAME)):
            ...
            if hasattr(self.args, "adaptive_norm_clip") and self.args.adaptive_norm_clip and 'LR_Scheduler' in opt_state_dict and 'adaptive_norm' not in opt_state_dict["LR_Scheduler"]:
            ...
            if hasattr(self.args, "adaptive_norm_clip") and self.args.adaptive_norm_clip and hasattr(self.optimizer._learning_rate, 'adaptive_norm'):
            ...
            # Note(GuoxiaWang): The checkpoint is not saved by ClipGradByAdaptiveNorm during training.
            # To avoid errors, add a temporary empty dict to the checkpoint.
            if hasattr(self.args, "adaptive_norm_clip") and self.args.adaptive_norm_clip and 'adaptive_norm' not in sched_state_dict:
