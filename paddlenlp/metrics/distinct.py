...
class Distinct(paddle.metric.Metric):
    ...
    that the Distinct here is different from the Distinct calculated in prediction, 
    and it is only for observation during training and evaluation.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            def trans_func(logits, tokenizer):
                ...
                # [batch_size, seq_len]
                token_ids = paddle.argmax(probs, axis=-1).numpy().tolist()
                cand_list = []
