...
template <typename T>
void cublasLtMM_INT8_withAlgo(int32_t *res, int batchCount, int m, int n, int k,
                         int64_t stridea, int64_t strideb, int64_t stridec,
                         const T *ATransform, const T *kernel, cublasLtHandle_t cublasLt_handle,
...
//used in decoder
template <typename T>
void cublasMM_cublasLtMM_wrapper_int8_decoder(
                                         cublasLtHandle_t ltHandle, cublasHandle_t handle, cublasOperation_t transa,
                                         ...
                                         cudaStream_t stream, void* cublas_workspace) {
