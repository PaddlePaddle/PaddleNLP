...
void embedding_position_lookups_fix_kernel_launcher(T* from_tensor,
  ...
  embedding_position_lookups_fix_kernel<T><<<grid, block, 0, stream>>>(
      from_tensor,
      embedding_table,
      pos_table,
      word_ids,
...
template void apply_logits_mask_kernelLauncher(float* log_probs,
                                               const bool* finished,
                                               int batch_size,
                                               int beam_width,
                                               int vocab_size_padded,
...
template void apply_logits_mask_kernelLauncher(half* log_probs,
                                               const bool* finished,
                                               int batch_size,
                                               int beam_width,
                                               int vocab_size_padded,
