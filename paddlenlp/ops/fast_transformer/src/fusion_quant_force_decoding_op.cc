...
#include "fusion_quant_force_decoding_op.h"
#include "pd_traits.h"
...
std::vector<paddle::Tensor> DecodingForward(
  ...
  if (input.place() == paddle::PlaceType::kGPU) {
    ...
    return QuantForceDecodingCUDAForward(input,
                               seq_len,
                               word_embedding,
                               self_ln_weight,
                               self_ln_bias,
...
std::vector<std::vector<int64_t>> DecodingInferShape(
    ...
    const std::vector<std::vector<int64_t>>& ffn_inter_weight_scale_shapes,
    const std::vector<std::vector<int64_t>>& ffn_inter_bias_shapes,
    const std::vector<std::vector<int64_t>>& ffn_out_weight_shapes,
    const std::vector<std::vector<int64_t>>& ffn_out_weight_scale_shapes,
...
std::vector<paddle::DataType> DecodingInferDtype(
    ...
    const std::vector<paddle::DataType>& ffn_inter_weight_scale,
    const std::vector<paddle::DataType>& ffn_inter_bias,
    const std::vector<paddle::DataType>& ffn_out_weight,
    const std::vector<paddle::DataType>& ffn_out_weight_scale,
...
PD_BUILD_OP(fusion_quant_force_decoding)
    .Inputs({"Input",
             "MemSeqLen",
             "WordEmbedding",
