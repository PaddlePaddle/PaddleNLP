...
def infer_miro_decoding(
        ...
        slf_ln_weight, slf_ln_bias, slf_q_weight,
    ...
    inputs_names = [
        ...
        "LogitsMask", "WordEmbedding", "PreDecoderLayernormWeight",
        "PreDecoderLayernormBias", "SelfLayernormWeight@VECTOR",
    ...
    return run_custom("fusion_miro", inputs_names, inputs_var,
...
class InferBartDecoding(nn.Layer):
    def __init__(self, model, decoding_lib=None, use_fp16_decoding=False):
        ...
        self.decoder_ln_weight = [model.decoder.decoder_layernorm_embedding.weight]
