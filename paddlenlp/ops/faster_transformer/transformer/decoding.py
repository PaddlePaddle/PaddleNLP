...
def convert_params(faster_model, model, fuse_qkv=1, use_fp16=False, restore_data=False):
    r"""
...
def convert_gptj_params(faster_model, model, fuse_qkv=1, use_fp16=False, restore_data=False, permutation=None):
    r"""
