...
|         `Taskflow("text_correction", model="ernie-csc")`          |         `$HOME/.paddlenlp/taskflow/text_correction/ernie-csc`          |        [Example](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/slm/examples/text_correction/ernie-csc)         |
...
<table>
  ...
  <tr><td>Text Error Correction<td>ERNIE-CSC<td> <a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/slm/examples/text_correction/ernie-csc"> Training Details <td> SIGHAN Simplified Chinese dataset and <a href="https://github.com/wdimmy/Automatic-Corpus-Generation/blob/master/corpus/train.sgml"> Automatic Corpus Generation dataset
