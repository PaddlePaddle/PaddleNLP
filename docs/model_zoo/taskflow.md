...
<table> 
  ...
  <tr><td>精确模式：WordTag<td> <a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/text_to_knowledge/ernie-ctm"> 训练详情 <td> 百度自建数据集
  ...
  <tr><td rowspan="2">命名实体识别<td>精确模式：WordTag<td> <a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/text_to_knowledge/ernie-ctm"> 训练详情 <td> 百度自建数据集
  <tr><td>快速模式：BiGRU+CRF <td> <a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/text_to_knowledge/ernie-ctm"> 训练详情 <td> 百度自建数据集，包含2200万句子，覆盖多种场景
  ...
  <tr><td>文本纠错<td>ERNIE-CSC<td> <a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/text_correction/ernie-csc"> 训练详情 <td> 百度自建数据集
  <tr><td>文本相似度<td>SimBERT<td> <a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/lexical_analysis"> 训练详情 <td> 收集百度知道2200万对相似句组
  ...
  <tr><td>生成式问答<td>CPM<td> - <td> 100GB中文数据
  <tr><td>智能写诗<td>CPM<td> - <td> 100GB中文数据
  <tr><td>开放域对话<td>PLATO-Mini<td> - <td> 百度自建数据集，十亿级别中文对话数据
</table>
