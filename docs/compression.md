...
对使用 ERNIE 3.0 Tiny-nano-v2 (4-layer, 312-hidden, 12-heads) 在意图识别、槽位填充任务上的模型进行压缩，精度基本无损，体积减小了 92.2%。端到端推理速度达到原来的 2.13 倍，内存占用减小了 62.18%，可参考 [ernie-tiny 文档](../model_zoo/ernie-tiny)。
...
以上脚本可以参考 [UIE](../model_zoo/uie/finetune.py)
