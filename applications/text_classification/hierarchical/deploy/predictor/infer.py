...
if __name__ == "__main__":
    ...
    if args.dataset_dir is not None:
        ...
        label_list = ['CS', 'ECE', 'Psychology', 'MAE', 'Civil', 'Medical', 'biochemistry', 'CS##Computer vision', 'CS##Machine learning', 'CS##network security', 'CS##Cryptography', 'CS##Operating systems', 'CS##Computer graphics', 'CS##Image processing', 'CS##Parallel computing', 'CS##Relational databases', 'CS##Software engineering', 'CS##Distributed computing', 'CS##Structured Storage', 'CS##Symbolic computation', 'CS##Algorithm design', 'CS##Computer programming', 'CS##Data structures', 'CS##Bioinformatics', 'ECE##Electricity', 'ECE##Lorentz force law', 'ECE##Electrical circuits', 'ECE##Voltage law', 'ECE##Digital control', 'ECE##System identification', 'ECE##Electrical network', 'ECE##Microcontroller', 'ECE##Electrical generator/Analog signal processing', 'ECE##Electric motor', 'ECE##Satellite radio', 'ECE##Control engineering', 'ECE##Signal-flow graph', 'ECE##State space representation', 'ECE##PID controller', 'ECE##Operational amplifier', 'Psychology##Prejudice', 'Psychology##Social cognition', 'Psychology##Person perception', 'Psychology##Nonverbal communication', 'Psychology##Prosocial behavior', 'Psychology##Leadership', 'Psychology##Eating disorders', 'Psychology##Depression', 'Psychology##Borderline personality disorder', 'Psychology##Seasonal affective disorder', 'Medical##Schizophrenia', 'Psychology##Antisocial personality disorder', 'Psychology##Media violence', 'Psychology##Prenatal development', 'Psychology##Child abuse', 'Psychology##Gender roles', 'Psychology##False memories', 'Psychology##Attention', 'Psychology##Problem-solving', 'MAE##computer-aided design', 'MAE##Hydraulics', 'MAE##Manufacturing engineering', 'MAE##Machine design', 'MAE##Fluid mechanics', 'MAE##Internal combustion engine', 'MAE##Thermodynamics', 'MAE##Materials Engineering', 'MAE##Strength of materials', 'Civil##Ambient Intelligence', 'Civil##Geotextile', 'Civil##Remote Sensing', 'Civil##Rainwater Harvesting', 'Civil##Water Pollution', 'Civil##Suspension Bridge', 'Civil##Stealth Technology', 'Civil##Green Building', 'Civil##Solar Energy', 'Civil##Construction Management', 'Civil##Smart Material', 'Medical##Addiction', 'Medical##Allergies', "Medical##Alzheimer's Disease", 'Medical##Ankylosing Spondylitis', 'Medical##Anxiety', 'Medical##Asthma', 'Medical##Atopic Dermatitis', 'Medical##Atrial Fibrillation', 'Medical##Autism', 'Medical##Skin Care', 'Medical##Bipolar Disorder', 'Medical##Birth Control', "Medical##Children's Health", "Medical##Crohn's Disease", 'Medical##Dementia', 'Medical##Diabetes', 'Medical##Weight Loss', 'Medical##Digestive Health', 'Medical##Emergency Contraception', 'Medical##Mental Health', 'Medical##Fungal Infection', 'Medical##Headache', 'Medical##Healthy Sleep', 'Medical##Heart Disease', 'Medical##Hepatitis C', 'Medical##Hereditary Angioedema', 'Medical##HIV/AIDS', 'Medical##Hypothyroidism', 'Medical##Idiopathic Pulmonary Fibrosis', 'Medical##Irritable Bowel Syndrome', 'Medical##Kidney Health', 'Medical##Low Testosterone', 'Medical##Lymphoma', 'Medical##Medicare', 'Medical##Menopause', 'Medical##Migraine', 'Medical##Multiple Sclerosis', 'Medical##Myelofibrosis', 'Medical##Cancer', 'Medical##Osteoarthritis', 'Medical##Osteoporosis', 'Medical##Overactive Bladder', 'Medical##Parenting', "Medical##Parkinson's Disease", 'Medical##Polycythemia Vera', 'Medical##Psoriasis', 'Medical##Psoriatic Arthritis', 'Medical##Rheumatoid Arthritis', 'Medical##Senior Health', 'Medical##Smoking Cessation', 'Medical##Sports Injuries', 'Medical##Sprains and Strains', 'Medical##Stress Management', 'biochemistry##Molecular biology', 'biochemistry##Cell biology', 'biochemistry##Human Metabolism', 'biochemistry##Immunology', 'biochemistry##Genetics', 'biochemistry##Enzymology', 'biochemistry##Polymerase chain reaction', 'biochemistry##Northern blotting', 'biochemistry##Southern blotting']
