...
对于标注样本充足的场景可以直接使用[预训练模型微调](../README.md)实现文本多分类，对于尚无标注或者标注样本较少的任务场景我们推荐使用小样本学习，以取得比微调方法更好的效果。下边通过**新闻分类**的例子展示如何使用小样本学习来进行文本分类。
