...
class LayoutXLMForTokenClassification_with_CRF(LayoutXLMPretrainedModel):
    def __init__(self, layoutxlm, num_classes, dropout=None):
        ...
        self.linear_chain_crf = Linear_chain_crf(size=self.num_classes, param_attr=paddle.fluid.ParamAttr(name='liner_chain_crfw'))
        self.crf_decoding = Crf_decoding(param_attr=paddle.fluid.ParamAttr(name='crfw_decode'), size=self.num_classes)
        self.crf_decoding.weight = self.linear_chain_crf.weight
        self.crfw = fluid.layers.create_parameter(shape=[self.num_classes + 2, self.num_classes], dtype='float32', name='crfw')
        self.mask_crfw = fluid.layers.create_parameter(shape=[self.num_classes + 2, self.num_classes], dtype='float32', name='mask_matrix')
