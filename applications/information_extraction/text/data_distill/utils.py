        ...
        for json_line in json_lines:
            ...
            for anno in annos:
                if anno['type'] == 'labels':
                    ...
                    ent_type = "object" if ent_label not in label_maps[
                        'entity2id'].keys() else ent_label
                    ent = {
                        "text": ent_text,
                        "type": ent_type,
                        "start_index": anno['value']['start']
        ...
        for json_line in json_lines:
            ...
            for entity in entities:
                ...
                ent = {
                    "text": ent_text,
                    "type": ent_type,
                    "start_index": entity['start_offset']
                }
