...
def create_fake_question(json_file,
                         ...
                         batch_size=8):
    with open(json_file,
              'r', encoding='utf-8') as rf, open(out_json,
                                                 'w',
        ...
        for i, json_line in enumerate(tqdm(all_lines)):
            ...
            if (i + 1) % batch_size == 0 or (all_sample_num and
                ...
                for context, answer, true_question in zip(
                        context_buffer, answer_buffer, true_question_buffer):
...
if __name__ == '__main__':
    ...
    create_fake_question(args.source_file_path, args.target_file_path,
                         args.num_return_sequences, args.all_sample_num,
                         args.batch_size)
