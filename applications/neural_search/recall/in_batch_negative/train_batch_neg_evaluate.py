...
# dev/recall
parser.add_argument("--corpus_file", type=str, default='../../data_set/recall/corpus.csv',
...
parser.add_argument("--recall_result_dir", type=str, default='../../data_set/recall_result_dir',
...
def do_train():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        recall_5 = evaluate(model, model_dev, corpus_data_loader,
                            query_data_loader, recall_result_file, text_list,
                            id2corpus)
