...
parser.add_argument("--test_file", default="test_data.txt", type=str, help="test file for classfication tasks.")
...
if __name__ == "__main__":
    ...
    test_ds = load_dataset(read_text_pair, data_path=args.test_file, lazy=False)
