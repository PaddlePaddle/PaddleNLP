...
from data_utils import convert_example, get_label_map

# yapf: disable
parser = argparse.ArgumentParser()
parser.add_argument("--save_dir", default='./checkpoint', type=str, help="The output directory where the model checkpoints will be written.")
parser.add_argument("--train_file", default="chnsenticorp", type=str, help="Train Dataset for classfication tasks.")
parser.add_argument("--test_file", default="chnsenticorp", type=str, help="Test Dataset for classfication tasks.")
...
parser.add_argument("--save_steps", default=50, type=int, help="The interval steps to save checkppoints.")
parser.add_argument("--logging_steps", default=10, type=int, help="The interval steps to logging.")
parser.add_argument("--init_from_ckpt", type=str, default=None, help="The path of checkpoint to be loaded.")
parser.add_argument("--seed", type=int, default=1000, help="random seed for initialization")
parser.add_argument("--task_name", type=str, required=True, help="The task name.")
parser.add_argument("--label_index", type=int, help="The label index.")
...
def read_text_pair(data_path, label_index=-1):
    """Reads data."""
...
def do_train():
    ...
    global_step = 0
    tic_train = time.time()
    file = open('result_{}.tsv'.format(args.task_name), 'a')
    for epoch in range(1, args.epochs + 1):
        for step, batch in enumerate(train_data_loader, start=1):
            ...
            if global_step % args.valid_steps == 0 and rank == 0:
                loss, accuracy = evaluate(model, criterion, metric,
                                          dev_data_loader)
                file.write("global_step:{}, {}, {}\n".format(global_step, loss,
                                                             accuracy))
                tic_train = time.time()
