...
def do_train(args):
    ...
    train_dataloader = paddle.base.reader.DataLoader.from_generator(capacity=70, return_list=True)
    train_dataloader.set_batch_generator(train_ds_iter, paddle.get_device())
    eval_dataloader = paddle.base.reader.DataLoader.from_generator(capacity=70, return_list=True)
    eval_dataloader.set_batch_generator(eval_ds_iter, paddle.get_device())
    test_dataloader = paddle.base.reader.DataLoader.from_generator(capacity=70, return_list=True)
