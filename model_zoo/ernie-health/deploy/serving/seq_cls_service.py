...
class ErnieHealthSeqClsOp(Op):
    def init_op(self):
        ...
        self.fetch_names = ["linear_147.tmp_1", ]
...
class ErnieHealthSeqClsService(WebService):
    def get_pipeline_response(self, read_op):
        return ErnieHealthSeqClsOp(name="seq_cls", input_ops=[read_op])


if __name__ == "__main__":
    ocr_service = ErnieHealthSeqClsService(name="seq_cls")
