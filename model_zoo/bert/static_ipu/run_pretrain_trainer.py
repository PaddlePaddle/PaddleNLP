...
from modeling_trainer import (
    IpuBertPretrainingMLMAccAndLoss, IpuBertPretrainingMLMHeads,
    IpuBertPretrainingNSPAccAndLoss, IpuBertPretrainingNSPHeads)
...
class PretrainIPUTrainer(IPUTrainer):
    ...
    def get_train_dataloader(self):
        input_files = [
            os.path.join(self.args.input_files, f)
            for f in os.listdir(self.args.input_files)
            if os.path.isfile(os.path.join(self.args.input_files, f)) and
            "training" in f
        ]
        input_files.sort()
