...
def parse_args():
    ...
    # graph
    parser.add_argument(
        "--encoder_start_ipu", type=int, default=0, help="Start encoder ipu")
    parser.add_argument(
        "--layers_per_ipu", type=int, default=6, help="Pipeline layers to ipus")
    parser.add_argument(
    ...
    parser.add_argument(
        "--type_vocab_size", type=int, default=2, help="type vocab size")
    parser.add_argument(
        "--hidden_dropout_prob",
        type=float,
        default=0.1,
