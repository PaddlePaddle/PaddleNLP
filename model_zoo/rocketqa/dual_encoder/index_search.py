...
parser.add_argument("--para_index_file",
                        type=str,
                        default='output',
                        help="The paragraph embedding file.")
parser.add_argument("--query_embedding_file",
                        type=str,
                        default='output',
                        help="The query embedding file.")
parser.add_argument("--query_text_file",
                        type=str,
                        default='output',
                        help="The query text path.")
parser.add_argument("--topk", default=50, type=int, help="The numbert of file for retrieval.")
parser.add_argument("--outfile", default='para.index.part', type=str, help="The output result file.")
...
def main():
    ...
    topk = args.topk
    q_text_file = args.query_text_file
    qid_list = load_qid(q_text_file)
    print('loading index')
    engine = faiss.read_index(args.para_index_file)
    print('search in index')
    search(engine, args.query_embedding_file, qid_list, args.outfile, topk)
