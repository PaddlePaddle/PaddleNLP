...
def run(args):
    ...
    if args.use_multi_layer_strategy:
        ...
        from multi_layer_modeling import ErnieMultiLayerFinetuningForMultipleChoice
        model = ErnieMultiLayerFinetuningForMultipleChoice.from_pretrained(
    ...
    if args.do_train:
        ...
        for epoch in range(args.num_train_epochs):
            for step, batch in enumerate(train_data_loader):
                ...
                logits = model(input_ids=input_ids, token_type_ids=segment_ids)
                if args.use_multi_layer_strategy:
                    logits_auxiliary, logits = logits
