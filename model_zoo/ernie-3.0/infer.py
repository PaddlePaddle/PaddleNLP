...
def parse_args():
    ...
    parser.add_argument("--use_trt", action="store_true", help="Whether to use inference engine TensorRT.")
    parser.add_argument("--use_lite", action="store_true", help="Whether to use inference engine PaddleLite.")
