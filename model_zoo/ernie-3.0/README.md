...
| ERNIE 3.0-Medium+裁剪+FP32      | 74.66 | 75.14 | 57.31 | 60.29   | 81.25 | 77.46 | 79.93       | 81.70 | 65.55/86.24 | 93.10/93.43/93.27 |
| ERNIE 3.0-Medium+裁剪+FP16      | 74.65 | 75.21 | 57.27 | 60.29   | 81.24 | 77.56 | 79.93       | 81.73 | 65.39/86.17 | 93.10/93.43/93.27 |
...
经过动态量化后，加速比分别达到 1.9、1.6、1.7 倍，精度分别下降 0.88、0.40、0.72。
...
|                            | 文本分类 性能 | 文本分类精度 | NER 性能      | NER精度      | 阅读理解性能 | 阅读理解精度 |
| -------------------------- | ------------- | ------------ | ------------- | ------------ | ------------ | ------------ |
...
| ERNIE 3.0-Medium+裁减+FP32 | 1424.01(1.3x) | 57.31(-0.14) | 454.27(1.2x)  | 93.27(+0.23) | 183.77(1.3x) | 65.55(-1.40) |
| ERNIE 3.0-Medium+裁减+FP16 | 3577.62(3.2x) | 57.27(-0.18) | 1138.77(3.1x) | 93.27(+0.23) | 445.71(3.0x) | 65.39(-1.56) |
| ERNIE 3.0-Medium+裁减+INT8 | 3635.48(3.2x) | 57.26(-0.19) | 1105.26(3.0x) | 93.20(+0.16) | 444.27(3.0x) | 65.30(-1.65) |


三类任务（分类、NER、阅读理解）经过裁剪、量化后加速比均达到 3 倍左右，所有任务上平均精度降低 0.54。
