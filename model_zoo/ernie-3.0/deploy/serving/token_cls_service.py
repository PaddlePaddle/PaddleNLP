...
class ErnieTokenClsOp(Op):
    ...
    def preprocess(self, input_dicts, data_id, log_id):
        ...
        data = self.tokenizer(
            data, max_length=128, padding=True, truncation=True, is_split_into_words=is_split_into_words
        )
    ...
    def postprocess(self, input_dicts, fetch_dict, data_id, log_id):
        ...
        for batch, token_label in enumerate(tokens_label):
            ...
            value.append(items)
        out_dict = {"value": json.dumps(value), "tokens_label": json.dumps(tokens_label)}
        # print(out_dict)
