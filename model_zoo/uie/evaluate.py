...
def do_eval():
    ...
    if args.separated:
        ...
        class_dict["All classes"] = test_ds
...
if __name__ == "__main__":
    ...
    parser.add_argument("--separated", action='store_true', help="Precision, recall and F1 score are calculated for each class separately if this option is enabled.")
