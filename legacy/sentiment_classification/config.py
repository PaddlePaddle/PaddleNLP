...
class PDConfig(object):
    ...
    def __init__(self, json_file=""):
        ...
        model_g.add_arg("senta_config_path", str, None,
        ...
        model_g.add_arg("model_type", str, "ernie_base",
                        "Type of current ernie model")
        model_g.add_arg("use_paddle_hub", bool, False,
        ...
        run_type_g.add_arg("do_infer", bool, True,
                           "Whether to perform inference.")
        run_type_g.add_arg("do_save_inference_model", bool, True,
                           "Whether to save inference model")
        run_type_g.add_arg("inference_model_dir", str, None,
