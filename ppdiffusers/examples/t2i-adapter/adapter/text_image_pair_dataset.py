                    ...
                    while True:
                        ...
                        if data is None:
                            ...
                            out = {
                                ...
                                "input_ids": self.text_processing(
                                    data["caption"]) if self.text_processing else data['caption'],
                                "adapter_cond": self.control_image_processor.process_data_load(
                                    control_image).numpy() if self.control_image_processor else control_image,
                            }
                            yield out
