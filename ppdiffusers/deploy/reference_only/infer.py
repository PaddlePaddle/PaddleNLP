...
import numpy as np
import paddle
from fd_reference_only import FastDeployReferenceOnlyPipeline
...
def parse_arguments():
    ...
    parser.add_argument("--inference_steps", type=int, default=20, help="The number of unet inference steps.")
...
def main(args):
    ...
    unet_dynamic_shape = {
        "sample": {
            ...
            "opt_shape": [bs, unet_in_channels, min_image_size // 8, min_image_size // 8],
        },
        "timestep": {
            "min_shape": [1],
            "max_shape": [1],
        ...
        "encoder_hidden_states": {
            ...
            "opt_shape": [bs, text_encoder_max_length, hidden_states],
        },
    }
    # 4. Init runtime
    ...
    pipe = FastDeployReferenceOnlyPipeline.from_pretrained(
        args.model_dir,
    ...
    for infer_op in infer_op_list:
        ...
        reference_image = load_image("dog_rel.png")
        time_costs = []
        # warmup
        pipe(
            prompt,
        ...
        print("==> Test reference only performance.")
        ...
        images[0].save(f"{folder}/reference_only.png")
