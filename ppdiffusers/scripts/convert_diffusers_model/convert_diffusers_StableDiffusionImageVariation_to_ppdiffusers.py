...
from diffusers import StableDiffusionImageVariationPipeline as DiffusersStableDiffusionImageVariationPipeline
from ppdiffusers import StableDiffusionImageVariationPipeline as PPDiffusersStableDiffusionImageVariationPipeline, AutoencoderKL, UNet2DConditionModel, PNDMScheduler, LMSDiscreteScheduler, DDIMScheduler
from ppdiffusers.pipelines.stable_diffusion import StableDiffusionSafetyChecker
from paddlenlp.transformers import CLIPVisionModel, CLIPFeatureExtractor, CLIPVisionModelWithProjection
