...
class IFSafetyChecker(PreTrainedModel):
    ...
    def __init__(self, config: CLIPConfig):
        ...
        self.p_head = nn.Linear(in_features=config.vision_config.projection_dim, out_features=1)
        self.w_head = nn.Linear(in_features=config.vision_config.projection_dim, out_features=1)
