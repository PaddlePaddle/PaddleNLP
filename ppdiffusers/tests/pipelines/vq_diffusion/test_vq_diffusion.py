...
from ppdiffusers import Transformer2DModel, VQDiffusionPipeline, VQDiffusionScheduler, VQModel
from ppdiffusers.pipelines.vq_diffusion.pipeline_vq_diffusion import LearnedClassifierFreeSamplingEmbeddings
...
class VQDiffusionPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_vq_diffusion(self):
        ...
        expected_slice = np.array([
            0.4555889964103699, 0.8180876970291138, 0.8191028237342834,
            0.4898788630962372, 0.7687911987304688, 0.5317288637161255,
            0.45981234312057495, 0.668595016002655, 0.5385899543762207
        ])
    ...
    def test_vq_diffusion_classifier_free_sampling(self):
        ...
        expected_slice = np.array([
            0.829240083694458, 0.9359513521194458, 0.4304574131965637,
            0.5211103558540344, 0.7989728450775146, 0.4413323700428009,
            0.5169486403465271, 0.5790078639984131, 0.4956228733062744
        ])
