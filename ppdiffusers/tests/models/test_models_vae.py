...
from ppdiffusers.utils import floats_tensor, load_hf_numpy, slow, paddle_all_close
...
class AutoencoderKLTests(ModelTesterMixin, unittest.TestCase):
    ...
    def test_output_pretrained(self):
        ...
        expected_output_slice = paddle.to_tensor([
            -0.37055650, -0.33920342, 0.08271024, -0.22468489, -0.04493487,
            0.02585240, -0.03970414, -0.08472210, -0.06026033
        ])
...
class AutoencoderKLIntegrationTests(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        [
            33,
            [
                -0.1603, 0.9878, -0.0495, -0.0790, -0.2709, 0.8375, -0.2060,
                -0.0824
            ]
        ],
        [
    ...
    def test_stable_diffusion(self, seed, expected_slice):
        ...
        with paddle.no_grad():
            sample = model(image, generator=generator,
    ...
    @parameterized.expand([
        ...
        [
            37,
            [
                -0.2632, -0.2625, -0.2199, -0.2741, -0.4539, -0.4990, -0.3720,
                -0.4925
            ]
        ],
        # fmt: on
    ...
    @parameterized.expand([
        ...
        [
            33,
            [
                -0.3001, 0.0918, -2.6984, -3.9720, -3.2099, -5.0353, 1.7338,
                -0.2065, 3.4267
            ]
        ],
        [
            47,
            [
                -1.5030, -4.3871, -6.0355, -9.1157, -1.6661, -2.7853, 2.1607,
                -5.0823, 2.5633
            ]
        ],
        # fmt: on
