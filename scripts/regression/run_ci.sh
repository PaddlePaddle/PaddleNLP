...
python -m pip config --user set global.index http://pypi.tuna.tsinghua.edu.cn/search/
python -m pip config --user set global.index-url http://pypi.tuna.tsinghua.edu.cn/simple
