...
function llm_gpt_dygraph_auto_bs8_fp32_DP2-MP2() {
    ...
    mem=-1
    echo "result: loss=$loss ips=$ips mem=$mem loss_md5=$loss_md5"
    loss_base=10.58118248 # output of dropout is different after supporting spmd
    ips_base=-1
    mem_base=-1
    if [ $IS_A100 -ne 0 ];then
...
function llm_gpt_dygraph_auto_bs8_fp32_DP2-MP2-PP2() {
    ...
    loss_base=10.57185364 # output of dropout is different after supporting spmd
    ips_base=-1
    mem_base=-1
    if [ $IS_A100 -ne 0 ];then
